...
ssh ubuntu@www.yesodweb.com 'cd whosawthatcoming && git fetch && git merge origin/master && mv whosawthatcoming whosawthatcoming.old && bunzip2 whosawthatcoming.bz2 && sudo restart whosawthatcoming'
